...
def train_model(run_id: str) -> None:
    ...
    with mlflow.start_run(run_id=run_id) as run:
        ...
        mlflow.log_param("lr_intercept", lr.intercept_)
        ...
        with open("models/linear_model.pkl", "wb") as f_out:
            pickle.dump(lr, f_out)
        mlflow.log_artifact("models/linear_model.pkl", artifact_path="models_lr")

        with open("models/dv.pkl", "wb") as f_out:
            pickle.dump(dv, f_out)
        mlflow.log_artifact("models/dv.pkl", artifact_path="models_lr")
